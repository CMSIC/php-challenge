...
<section class="">
    <div class="container px-6 py-10 mx-auto ">
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 sm:grid-cols-2 xl:grid-cols-4 lg:grid-cols-3">
            <div class="w-full ">
                <div class="w-full h-64 bg-gray-300 rounded-lg dark:bg-gray-600 border border-slate-50 flex" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal">
                    <img src="../../public/assets/img/icon-add-movie.png" alt="" class="m-auto ">
                </div>
